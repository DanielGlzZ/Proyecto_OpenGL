...
public class MyCanvas extends GLCanvas implements GLEventListener, KeyListener {
    ...
    public void init(GLAutoDrawable glad) {
        ...
        // Cargar los objetos dentro del contexto de OpenGL
         try {
            obj1 = or.Load("./Objetos/12984_beach_umbrella_v1_L2.obj");
        ...
        try {
            obj2 = or.Load("./Objetos/13517_Beach_Ball_v2_L3.obj");
        ...
        try {
            obj3 = or.Load("./Objetos/13519_Beach_Towels_v2_L2.obj");
    ...
    public void display(GLAutoDrawable glad) {
        ...
        */
        ...
        if (obj2 != null) {
            gl.glTranslatef(pox+80.0f, poy, poz);        
            gl.glRotatef(rotate, 0.0f, 0.0f, 0.0f);
            gl.glScalef(1.0f, 1.0f, 1.0f);
            obj2.draw(gl);
        }
